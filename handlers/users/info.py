...
async def bot_info(message: types.Message):
    text = '<b>Добро пожаловать в студию разработки Delpy Studio! 👨‍💻 </b> \n\nРады приветсвовать вас в нашем официальном телеграм боте! \n\n Здесь вы сможете: \n<i>- Ознакомиться с нашим портфолио\n- Посмотреть перечень наших услуг\n- Получить ссылку на наш Git Hub & Kwork\n- Задать вопрос нашим админам\n- Составить ваш заказ на Google Forms </i>'
